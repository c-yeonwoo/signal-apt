...
백테스트는 연구용 과거 집계이며 현재 매물의 확률이 아니다. 개별 매수·매도 단정 금지.
...
SYSTEM = (
    "당신은 한국 부동산 의사결정을 돕는 데이터 애널리스트 '닉'입니다. "
...
TOOLS = [
    ...
    {
        "name": "get_backtest",
        "description": "시그널 발생 후 달력 12주가 완성된 과거 관측의 연구용 집계. 당시 공표 원본이 없어 미래정보 제거를 보증하지 않으며 현재 매물의 상승 확률로 사용 금지.",
        "input_schema": {"type": "object", "properties": {}},
    },
    {
        "name": "get_timing",
    ...
    },
    {
        ...
        "description": "사용자 관심지역·관심단지·최근 닉 대화 기억(지역/단지/질문 요약). '내가 관심 있던 곳'·이어가기 질문에 사용.",
        "input_schema": {"type": "object", "properties": {}},
    },
    {
        "name": "get_regime",
