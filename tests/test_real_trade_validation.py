...
def test_v2_uses_month_after_onset_and_same_month_market_baseline(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(v2, "signal_history", lambda *_a, **_k: [
        {"signal": "STRONG_BUY", "start": "2020-12-25", "end": "2021-03-25"},
    ])
...
def test_v2_skips_months_with_too_few_transactions(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(v2, "signal_history", lambda *_a, **_k: [
        {"signal": "BUY", "start": "2020-12-25", "end": "2021-03-25"},
    ])
